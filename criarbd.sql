...
INSERT INTO "Selecionar Mês e Ano" ("Mês","Ano") VALUES (6,2024);
INSERT INTO "Banca" ("Mês","Ano","Valor_Inicial","Lucro_R$","Lucro_%","Valor_Final","Stake") VALUES (7,2024,0,0,0,0,0);
INSERT INTO "Status_Aposta" ("Cod_Status","Status") VALUES (1,'Green'),
 ...
 (6,'Meio Green'),
 (7,'Meio Red');
INSERT INTO "Competições" ("Selec.","Competição","País","Mercados","Green","Red","P/L","Total") VALUES (0,'Brasileirão Série A','Brasil',0,0,0,0,0),
 (0,'Brasileirão Série B','Brasil',0,0,0,0,0),
 (0,'Eurocopa','Europa',0,0,0,0,0),
 ...
 (0,'Copa da Holanda','Holanda',0,0,0,0,0),
...
INSERT INTO "Estratégias" ("Cod_Estratégia","Selec.","Estratégia","Mercados_Estr","Profit_Estr") VALUES (4,0,'Back Favorito',0,0.0),
 ...
 (16,0,'Aposta Múltipla',0,0.0),
 (17,0,'Outros',0,0.0);
INSERT INTO "Países" ("Selec.","País","Mercados","Greens","Reds","P/L") VALUES (0,'Brasil',1,0,0,0),
 ...
 (0,'Bulgária',0,0,0,0),
 (0,'Equador',0,0,0,0);
INSERT INTO "Times" ("Selec.","Time","País","Mandante","Visitante","Greens","P/L","Reds") VALUES (0,'Criciúma','Brasil',0,0,0,0,0),
 (0,'Próspera','Brasil',0,0,0,0,0),
 (0,'Palmeiras','Brasil',0,0,0,0,0),
 (0,'Cruzeiro','Brasil',0,0,0,0,0),
 ...
 (0,'Corinthians','Brasil',0,0,0,0,0),
 (0,'Fluminense','Brasil',0,0,0,0,0),
 (0,'Botafogo','Brasil',0,0,0,0,0),
 (0,'Athletico PR','Brasil',0,0,0,0,0),
 (0,'Cuiabá','Brasil',0,0,0,0,0),
...
INSERT INTO "ControleVersao" ("Versao") VALUES (2);
CREATE TRIGGER "Recálculo Países (Update)"
...
BEGIN
    ...
    WHERE País = NEW.País;
END;
CREATE TRIGGER "Recálculo Países (Insert)"
...
BEGIN
    ...
    WHERE País = NEW.País;
END;
CREATE TRIGGER after_insert_times
AFTER INSERT ON Times
FOR EACH ROW
BEGIN
    UPDATE Times
    ...
    WHERE "Time" = NEW."Time";
END;
CREATE TRIGGER "Corrige Valores"
...
END;
CREATE TRIGGER "Recálculo Países (Delete)"
...
BEGIN
    ...
    WHERE País = OLD.País;
END;
CREATE TRIGGER after_insert_apostas
...
END;
CREATE TRIGGER after_delete_apostas
...
END;
CREATE TRIGGER "Atualizar Contadores Times (Update)"
...
BEGIN
    ...
    WHERE "Time" = NEW.Visitante;
END;
CREATE TRIGGER "Atualizar Contadores Times (Delete)"
AFTER DELETE ON Apostas
BEGIN
    UPDATE Times
    SET Mandante = Mandante - 1
    ...
    WHERE "Time" = OLD.Visitante;
END;
CREATE TRIGGER "Atualizar Contadores Times (Insert)"
AFTER INSERT ON Apostas
BEGIN
    UPDATE Times
    SET Mandante = Mandante + 1
    ...
    WHERE "Time" = NEW.Visitante;
END;
CREATE TRIGGER after_update_apostas
AFTER UPDATE ON Apostas
FOR EACH ROW
BEGIN
    -- Se Mandante mudou
...
BEGIN
    ...
    WHERE rowid > NEW.rowid;
END;
CREATE TRIGGER "Atualizar Contadores Mercados Competição (Delete)"
AFTER DELETE ON Apostas
BEGIN
    UPDATE Competições
...
END;
CREATE TRIGGER "Atualizar Contadores Mercados Competição (Update)"
AFTER UPDATE ON Apostas
BEGIN
    UPDATE Competições
    SET Mercados = Mercados + 1
    ...
    WHERE "Competição" = OLD.Competição_AP;
END;
CREATE TRIGGER "Atualizar Contadores Mercados Competição (Insert)"
AFTER INSERT ON Apostas
BEGIN
    UPDATE Competições
    SET Mercados = Mercados + 1
    WHERE "Competição" = NEW.Competição_AP;
END;
CREATE TRIGGER "Atualizar Estratégias Times (Insert)"
AFTER INSERT ON Apostas
BEGIN
    UPDATE Estratégias
...
END;
CREATE TRIGGER "Atualizar Estratégias Times (Update)"
AFTER UPDATE ON Apostas
BEGIN
    UPDATE Estratégias
    SET Mercados_Estr = Mercados_Estr + 1
...
END;
CREATE TRIGGER "Atualizar Estratégias Times (Delete)"
AFTER DELETE ON Apostas
BEGIN
    UPDATE Estratégias
    SET Mercados_Estr = Mercados_Estr - 1
    WHERE "Estratégia" = OLD.Estratégia_Escolhida;
END;
CREATE TRIGGER "Atualizar Greens e Reds P/L Times (Insert)"
AFTER INSERT ON Apostas
BEGIN
    UPDATE Times
...
END;
CREATE TRIGGER "Atualizar Greens Reds P/L Time (Update)"
AFTER UPDATE ON Apostas
BEGIN
    UPDATE Times
...
END;
CREATE TRIGGER "Atualizar Greens Reds P/L Time (Delete)"
AFTER DELETE ON Apostas
BEGIN
    UPDATE Times
    ...
    WHERE "Time" = OLD.Mandante OR "Time" = OLD.Visitante;
END;
CREATE TRIGGER "Calcular Porcentagem Lucro"
after update on Banca 
for each row 
begin 
UPDATE Banca
    ...
    WHERE rowid = NEW.rowid;
END;
CREATE TRIGGER "Calcular Porcentagem Lucro (Insert)"
...
UPDATE Banca
    ...
    WHERE rowid = NEW.rowid;
END;
CREATE TRIGGER "Calcula Banca Final (Insert)"
after insert on Banca 
begin
update Banca
...
CREATE TRIGGER "Calcula Banca Final (Update)"
after update on Banca 
begin
update Banca
set Valor_Final = Valor_Inicial + Lucro_R$
...
CREATE TRIGGER "Calcular Lucro (Delete)"
...
BEGIN
    ...
    WHERE Ano = strftime('%Y', NEW.Data) 
      AND Mês = strftime('%m', NEW.Data);
END;
CREATE TRIGGER "Calcular Lucro (Update)"
AFTER Update ON Apostas
FOR EACH ROW
BEGIN
    UPDATE Banca
    ...
    WHERE Ano = strftime('%Y', NEW.Data) 
      AND Mês = strftime('%m', NEW.Data);
END;
CREATE TRIGGER "Calcular Lucro (Insert)"
AFTER INSERT ON Apostas
FOR EACH ROW
BEGIN
    UPDATE Banca
